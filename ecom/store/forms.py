...
class SignUpForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['username'].widget.attrs.update({**field_attrs, 'placeholder': 'Username'})
        self.fields['password1'].widget.attrs.update({**field_attrs, 'placeholder': 'Password'})
        self.fields['password2'].widget.attrs.update({**field_attrs, 'placeholder': 'Confirm Password'})
